                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <select name="kategori" onchange="this.form.submit()" class="form-select">
                                ...
                                <option value="Other" {{ request('kategori') == 'Other' ? 'selected' : '' }}>Lainnya
                                </option>
                            </select>
                        </div>
                            ...
                            <div class="mb-3">
                                <div class="input-group">
                                    <input type="text" name="search" value="{{ request('search') }}"
                                        class="form-control" id="exampleInputIconRight" placeholder="Search"
                                        aria-label="Search">
                                    ...
                                    @if (request('search'))
                                        <a href="{{ url()->current() }}" class="btn btn-outline-secondary ml-3"
                    ...
                    <tbody>
                        @foreach ($dataProduk as $row)
                            <tr>
                                ...
                                <td> <a href="{{ route('produk.edit', $row->produk_id) }}" class="btn btn-info btn-sm">
