...
@section('content')
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            ...
            <p class="mb-0">List data produk</p>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <select name="kategori" onchange="this.form.submit()" class="form-select">
                                ...
                                <option value="Other" {{ request('kategori') == 'Other' ? 'selected' : '' }}>Lainnya</option>
                            </select>
                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($row->kategori === 'Makanan')
                                        <span class="badge bg-info">Makanan</span>
                                    @elseif($row->kategori === 'Minuman')
                                        <span class="badge bg-secondary">Minuman</span>
                                    @elseif($row->kategori === 'Other')
                                        <span class="badge bg-primary">Other</span>
                                    @endif
                                </td>
                                <td> {{ $row->harga }} </td>
                                <td> {{ $row->stok }} </td>
                                <td> <img src="{{ asset('gambar/' . $row->gambar) }}" width="100px" alt="gambar"></td>
                                <td> <a href="{{ route('produk.edit', $row->produk_id) }}"
