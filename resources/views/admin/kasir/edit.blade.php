...
@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            ...
            <h2 class="h4">Tambah Penjualan</h2>
            <p class="mb-0">Form Perubahan Data Penjualan</p>
        </div>
        <div class="btn-toolbar mb-2 mb-md-0">
            <a href="{{ route('kasir.list') }}" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
                Kembali
            </a>
    ...
    <div class="card card-body border-0 shadow mb-4">
        ...
        <form action="{{ route('kasir.update') }}" method="POST">
                ...
                <div class="col-md-6 mb-3">
                    <div>
                        ...
                        <input class="form-control" id="nama_pelanggan" name="nama_pelanggan" type="text"
                            value="{{ $dataKasir->nama_pelanggan }}" placeholder="Enter your Nama Pelanggan" required="">
                    </div>
                </div>
                <div class="col-md-6 mb-3">
                    <div>
                        <label for="pesanan">Pesanan</label>
                        <input class="form-control" id="pesanan" name="pesanan" type="text"
                            value="{{ $dataKasir->pesanan }}" placeholder="Also your Pesanan" required="">
                    </div>
                </div>
            </div>
            <div class="row align-items-center">
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input data-datepicker="" class="form-control datepicker-input" id="tanggal_pemesanan" name="tanggal_pemesanan"
                            type="date" value="{{ $dataKasir->tanggal_pemesanan }}" placeholder="dd/mm/yyyy" required="">
                ...
                <div class="col-md-6 mb-3">
                    <div class="form-group">
                        ...
                        <input class="form-control" id="jumlah_pesanan" name="jumlah_pesanan" type="number"
                            value="{{ $dataKasir->jumlah_pesanan }}" placeholder="Jumlah pesanan anda" required="">
                    </div>
                </div>
                {{-- <div class="col-md-6 mb-3">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select mb-0" id="gender" name="gender" aria-label="Gender select example">
                        ...
                        <option value="Female" {{ $dataKasir->gender == 'Female' ? 'selected' : '' }}>Female
                        </option>
                        <option value="Male" {{ $dataKasir->gender == 'Male' ? 'selected' : '' }}>Male</option>
                    </select>
                </div> --}}
            </div>
            <div class="row">
                <div class="col-md-6 mb-3">
                    <div class="form-group">
                        ...
                        <input class="form-control" id="total_harga" name="total_harga" type="number"
                            value="{{ $dataKasir->total_harga }}" placeholder="Total harga penjualan" required="">
                    </div>
                </div>
                <div class="col-md-6 mb-3">
                    <label for="metode_pembayaran">Metode Pembayaran</label>
                    <select class="form-select mb-0" id="metode_pembayaran" name="metode_pembayaran" aria-label="metode_pembayaran select example">
                        <option selected>Metode Pembayaran</option>
                        <option value="Tunai" {{ $dataKasir->metode_pembayaran == 'Tunai' ? 'selected' : '' }}>Tunai
                        </option>
                        <option value="Transfer" {{ $dataKasir->metode_pembayaran == 'Transfer' ? 'selected' : '' }}>Transfer</option>
                        <option value="QRIS" {{ $dataKasir->metode_pembayaran == 'QRIS' ? 'selected' : '' }}>QRIS</option>
                    </select>
                </div>
            </div>
            ...
            <input type="hidden" name="kasir_id" value="{{ $dataKasir->kasir_id }}" />
        </form>
    </div>
@endsection
