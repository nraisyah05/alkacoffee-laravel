...
@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            ...
            <h2 class="h4">Data Penjualan</h2>
            <p class="mb-0">Form Penambahan Penjualan Baru</p>
        </div>
                ...
                <div class="col-md-6 mb-3">
                    <div>
                        ...
                        <input class="form-control" id="nama_pelanggan" name="nama_pelanggan" type="text"
                            placeholder="Enter your Nama Pelanggan" required="">
                    </div>
                </div>
                <div class="col-md-6 mb-3">
                    <div>
                        ...
                        <input class="form-control" id="pesanan" name="pesanan" type="text"
                            placeholder="Also your Pesanan" required="">
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6 mb-3">
                    <div class="form-group">
                        ...
                        <input class="form-control" id="total_harga" name="total_harga" type="number"
                            placeholder="Masukkan total harga pembelian" required="">
                    </div>
                </div>
                <div class="col-md-6 mb-3">
