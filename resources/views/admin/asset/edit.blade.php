...
@section('content')
        ...
        <div class="d-block mb-4 mb-md-0">
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('asset.list')}}">Asset</a></li>
                    <li class="breadcrumb-item active">Edit Data </li>
                </ol>
            </nav>
            <h2 class="h4">Tambah Asset</h2>
            <p class="mb-0">Form Perubahan Data Asset</p>
        </div>
        <div class="btn-toolbar mb-2 mb-md-0">
            <a href="{{ route('asset.list') }}" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
                Kembali
            </a>
    ...
    <div class="card card-body border-0 shadow mb-4">
        ...
        <form action="{{ route('asset.update') }}" method="POST">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <div>
                        ...
                        <input class="form-control" id="nama_asset" name="nama_asset" type="text"
                            value="{{ $dataAsset->nama_asset }}" placeholder="Enter your Nama Asset" required="">
                    </div>
                </div>
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select mb-0" id="kategori" name="kategori" aria-label="kategori select example">
                        ...
                        <option value="Mesin" {{ $dataAsset->kategori == 'Mesin' ? 'selected' : '' }}>Mesin</option>
                        <option value="Alat" {{ $dataAsset->kategori == 'Alat' ? 'selected' : '' }}>Alat</option>
                        <option value="Inventaris" {{ $dataAsset->kategori == 'Inventaris' ? 'selected' : '' }}>Inventaris</option>
                    </select>
                </div>
            </div>
            <div class="row align-items-center">
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input data-datepicker="" class="form-control datepicker-input" id="tanggal_pembelian" name="tanggal_pembelian"
                            type="date" value="{{ $dataAsset->tanggal_pembelian }}" placeholder="dd/mm/yyyy" required="">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input data-datepicker="" class="form-control datepicker-input" id="tanggal_kadaluarsa" name="tanggal_kadaluarsa"
                            type="date" value="{{ $dataAsset->tanggal_kadaluarsa }}" placeholder="dd/mm/yyyy" required="">
                        <div class="datepicker datepicker-dropdown datepicker-orient-left datepicker-orient-bottom"
                            style="left: 341px; top: 375px;">
                            <div class="datepicker-picker">
                                <div class="datepicker-header">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select mb-0" id="status" name="status" aria-label="status select example">
                        ...
                        <option value="Aktif" {{ $dataAsset->status == 'Aktif' ? 'selected' : '' }}>Aktif</option>
                        <option value="Kadaluarsa" {{ $dataAsset->status == 'Kadaluarsa' ? 'selected' : '' }}>Kadaluarsa</option>
                        <option value="Maintenance" {{ $dataAsset->status == 'Maintenance' ? 'selected' : '' }}>Maintenance</option>
                    </select>
                </div>
            </div>
            ...
            <input type="hidden" name="asset_id" value="{{ $dataAsset->asset_id }}" />
        </form>
    </div>
@endsection
