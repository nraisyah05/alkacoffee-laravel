        ...
        <form action="{{ route('mitra.store') }}" method="POST">
                ...
                <div class="col-md-6 mb-3">
                    <div>
                        ...
                        <input class="form-control" id="nama_mitra" name="nama_mitra" type="text"
                            placeholder="Masukkan nama mitra anda" required="">
                    </div>
                </div>
                <div class="col-md-6 mb-3">
                    <div>
                        <label for="last_name">Alamat Mitra</label>
                        <input class="form-control" id="alamat" name="alamat" type="text"
                            placeholder="Alamat mitra anda" required="">
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input data-datepicker="" class="form-control datepicker-input" id="tanggal_bergabung"
                            name="tanggal_bergabung" type="date" placeholder="dd/mm/yyyy" required="">
            ...
            <div class="form-group mt-3">
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="checkbox_konfirmasi" name="checkbox_konfirmasi"
                        required>
                    <label class="form-check-label" for="checkbox_konfirmasi">
                        Data ini benar dan dapat dipertanggungjawabkan dengan semestinya
                    </label>
                </div>
                @if ($errors->has('checkbox_konfirmasi'))
                    <div class="text-danger">
                        {{ $errors->first('checkbox_konfirmasi') }}
                    </div>
                @endif
            </div>
